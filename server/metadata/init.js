...
class CatTemplatesSys_profileRow extends TabularSectionRow{
get sys(){return this._getter('sys')}
set sys(v){this._setter('sys',v)}
}
$p.CatTemplatesSys_profileRow = CatTemplatesSys_profileRow;
class CatTemplatesSys_furnRow extends TabularSectionRow{
get furn(){return this._getter('furn')}
set furn(v){this._setter('furn',v)}
}
$p.CatTemplatesSys_furnRow = CatTemplatesSys_furnRow;
