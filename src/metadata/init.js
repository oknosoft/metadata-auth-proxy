...
module.exports = function meta_init($p) {
  $p.wsql.alasql('USE md; DROP TABLE IF EXISTS cch_mdm_groups; DROP TABLE IF EXISTS cat_abonents; DROP TABLE IF EXISTS cat_branches; DROP TABLE IF EXISTS cat_http_apis; DROP TABLE IF EXISTS cat_servers; DROP TABLE IF EXISTS cat_users; DROP TABLE IF EXISTS cat_work_centers; DROP TABLE IF EXISTS cat_work_center_kinds; DROP TABLE IF EXISTS cat_production_kinds; DROP TABLE IF EXISTS ireg_i18n; DROP TABLE IF EXISTS ireg_delivery_schedules; DROP TABLE IF EXISTS ireg_delivery_scheme; DROP TABLE IF EXISTS ireg_predefined_elmnts;', []);
