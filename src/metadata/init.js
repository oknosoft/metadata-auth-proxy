...
class CatAbonentsExcludeRow extends TabularSectionRow{
get obj(){return this._getter('obj')}
set obj(v){this._setter('obj',v)}
}
$p.CatAbonentsExcludeRow = CatAbonentsExcludeRow;
