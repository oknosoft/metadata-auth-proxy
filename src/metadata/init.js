...
/**
* ### Справочник СвойстваШаблонов
* Свойства шаблонов
* @class CatTemplate_props
* @extends CatObj
* @constructor 
*/
class CatTemplate_props extends CatObj{
get xmin(){return this._getter('xmin')}
set xmin(v){this._setter('xmin',v)}
get xmax(){return this._getter('xmax')}
set xmax(v){this._setter('xmax',v)}
...
$p.CatTemplate_props = CatTemplate_props;
$p.cat.create('template_props');
...
class CatHttp_apisInsertsRow extends TabularSectionRow{
get identifier(){return this._getter('identifier')}
set identifier(v){this._setter('identifier',v)}
get name(){return this._getter('name')}
set name(v){this._setter('name',v)}
...
$p.CatHttp_apisInsertsRow = CatHttp_apisInsertsRow;
