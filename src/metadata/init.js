...
$p.CatCnnsSizesRow = CatCnnsSizesRow;
$p.cat.create('cnns');
...
get note(){return this._getter('note')}
set note(v){this._setter('note',v)}
get note_furn(){return this._getter('note_furn')}
set note_furn(v){this._setter('note_furn',v)}
get note_filling(){return this._getter('note_filling')}
set note_filling(v){this._setter('note_filling',v)}
}
